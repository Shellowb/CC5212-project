...
raw_table = LOAD 'hdfs://cm:9000/uhadoop2019/fplana/GlobalLandTemperaturesByCity.csv.gz' USING PigStorage(',') 
AS (date:charArray,avgTemp:double,avgTempUnc:double,City:charArray,Country:charArray,Lat:charArray,Longit:charArray);
